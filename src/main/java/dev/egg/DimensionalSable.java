...
public class DimensionalSable {
    ...
    public DimensionalSable(IEventBus modEventBus, ModContainer modContainer) {
        ...
        if (ModList.get().isLoaded("create")) {
            ...
            BlockEntityRegistry.PublishCustomFixer("create","sticky_mechanical_piston", new MechanicalPistonBlockEntity());
            ...
            BlockEntityRegistry.PublishPosFixer("create", "display_link", Set.of("TargetOffset"));
